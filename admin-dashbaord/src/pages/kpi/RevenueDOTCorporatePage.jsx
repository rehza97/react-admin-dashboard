...
const RevenueDOTCorporatePage = () => {
  ...
  const fetchData = async () => {
    try {
      setLoading(true);
      setError(null);
      const response = await kpiService.getDOTCorporateRevenueKPIs(filters);
      setData(response);
      ...
      console.error("Error fetching DOT Corporate revenue data:", err);
      setError(
        "Failed to load DOT Corporate revenue data. Please try again later."
      );
    } finally {
      setLoading(false);
    }
  ...
  return (
    <PageLayout
      title="DOT Corporate Revenue Analysis"
      subtitle="Monitor and analyze DOT Corporate revenue performance"
    >
      {/* Filters */}
      <Box sx={{ p: 3, mb: 2 }}>
...
export default RevenueDOTCorporatePage;
