          ...
          >
            ...
            >
              <polygon
                ...
                style={{
                  fill:
                    activeLinks["Adrar"] && MOCK_REGION_DATA["Adrar"]
                      ? getHeatMapColor(
                          MOCK_REGION_DATA["Adrar"][dataMetric],
                          getMaxValue()
                        )
            ...
            >
              <path
                ...
                style={{
                  fill:
                    activeLinks["Chlef"] && MOCK_REGION_DATA["Chlef"]
                      ? getHeatMapColor(
                          MOCK_REGION_DATA["Chlef"][dataMetric],
                          getMaxValue()
                        )
                      : theme.palette.mode === "dark"
                      ? "#555"
...
export default memo(EnhancedMap);
